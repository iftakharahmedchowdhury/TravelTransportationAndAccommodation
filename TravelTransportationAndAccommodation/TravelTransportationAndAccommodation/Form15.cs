...
namespace TravelTransportationAndAccommodation
{
    public partial class Form15 : Form
    {
        ...
        private void f15BackE(object sender, EventArgs e)
        {
            this.pictureBox1.Image = ((System.Drawing.Image)(Properties.Resources.backButtonHover));
        }

        private void f15BackL(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd2 = new SqlCommand("Update CoxBazarInformation set availableTicket = @availableTicket,availableHotel = @availableHotel, busName=@busName,hotelName=@hotelName  where customerUserName  =@customerUserName", conn1);
