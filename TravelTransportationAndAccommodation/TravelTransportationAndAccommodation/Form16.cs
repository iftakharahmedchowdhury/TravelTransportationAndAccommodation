...
namespace TravelTransportationAndAccommodation
{
    public partial class Form16 : Form
    {
            ...
            if (r1.IsMatch(textBox7.Text))
            {
                ...
                if (r2.IsMatch(textBox1.Text))
                {
                    ...
                    if (r3.IsMatch(textBox3.Text))
                    {
                        ...
                        conn.Open();
                        SqlCommand cmd = new SqlCommand("insert into bandarbanInformation values (@placeName,@customerUserName,@CustomerName,@CustomerPhoneNumber,@busName,@availableTicket,@hotelName,@availableHotel,@customerTicket,@customerAccommodation)", conn);
                        ...
                        SqlCommand cmd2 = new SqlCommand("Update bandarbanInformation set availableTicket = @availableTicket,availableHotel = @availableHotel where customerUserName  =@customerUserName", conn1);
                        ...
                        SqlCommand cmd3 = new SqlCommand("Select availableTicket,availableHotel from bandarbanInformation where customerUserName  =@customerUserName", conn2);
        ...
        private void Form16_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd3 = new SqlCommand("Select availableTicket,availableHotel,busName,hotelName from bandarbanInformation where customerUserName  =@customerUserName", conn2);
            cmd3.Parameters.AddWithValue("@customerUserName", "manager1");
        ...
        private void F16BackE(object sender, EventArgs e)
        {
            this.pictureBox1.Image = ((System.Drawing.Image)(Properties.Resources.backButtonHover));
        }

        private void F16BackL(object sender, EventArgs e)
        {
