...
namespace TravelTransportationAndAccommodation
{
    public partial class Form18 : Form
    {
        ...
        private void F18BackE(object sender, EventArgs e)
        {
            this.pictureBox1.Image = ((System.Drawing.Image)(Properties.Resources.backButtonHover));
        }

        private void F18BackL(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd2 = new SqlCommand("Update bandarbanInformation set availableTicket = @availableTicket,availableHotel = @availableHotel, busName=@busName,hotelName=@hotelName  where customerUserName  =@customerUserName", conn1);
